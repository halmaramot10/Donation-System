<%-- 
    Document   : food_edit_form
    Created on : Jan 4, 2020, 5:52:48 PM
    Author     : Hazel Anne
--%>
                        ...
                        <div class="card">
                            <div class="card-body">                              
                                <div class="form-validation">
                                    ...
                                    <form class="form-valide" action="Update_Food" method="post">
                                        <input type="hidden" name="id" value="<%=fid%>">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="itemdesc">Item Description<span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="itemdesc" name="item_desc" value="<%=desc%>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <select class="form-control" id="type" name="item_type">
                                        ...
                                        <div class="form-group row">        
                                            ...
                                            <div class="col-lg-6">
                                                <input name="received" type="text" class="form-control" id="datepicker3" value="<%=rec%>">
                                            </div>
                                        </div> 
                                        ...
                                        <div class="form-group row">        
                                            ...
                                            <div class="col-lg-6">
                                                <input name="expire" type="text" class="form-control" id="datepicker4" value="<%=exp%>">
                                            </div>
                                        </div>         
                                        ...
                                        <div class="form-group row">        
                                            ...
                                            <div class="col-lg-6">
                                                <input name="released" type="text" class="form-control" id="datepicker5" value="<%=don%>">
                                            </div>
                                        </div>   
