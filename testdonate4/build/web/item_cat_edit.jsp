<%-- 
    Document   : item_cat_edit
    Created on : Jan 4, 2020, 8:33:36 PM
    Author     : Hazel Anne
--%>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">List of Item Categories</h4>
                                    ...
                                    <table class="table table-striped table-bordered zero-configuration">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="item_edit_form.jsp?id=<%=rs.getInt("id")%>">Edit</a></td>
                                            </tr>
