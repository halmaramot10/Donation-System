...
public class Add_Money extends HttpServlet {
    ...
    Statement st;
    ResultSet rs;
    String itemdesc = null, itemtype = null,amt = null,stat = null, donate = null, daterec = null, datedon = null;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String sql = "insert into money_donate(item_desc,item_type,amount,status,donatedto,daterec,datedon) values "
                    + "('"+itemdesc+"','"+itemtype+"','"+amt+"','"+stat+"','"+donate+"','"+daterec+"','"+datedon+"')";
            ...
            if(status>0)
                {
                    ...
                    response.sendRedirect("money_add.jsp");
