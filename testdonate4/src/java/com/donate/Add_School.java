...
@WebServlet(name = "Add_School", urlPatterns = {"/Add_School"})
public class Add_School extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String sql = "insert into school_donate(item_desc,item_type,quantity,conditions,status,donatedto,daterec,datedon) values "
