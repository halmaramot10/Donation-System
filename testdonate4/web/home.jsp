<%-- 
    Document   : home.jsp
    Created on : Dec 27, 2019, 4:35:24 PM
    Author     : Hazel Anne
--%>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-1">
                            <div class="card-body">
                                <h3 class="card-title text-white"><a href="user_add.jsp" style="color:white">Products Sold</a></h3>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-2">
                            <div class="card-body">
                                <h3 class="card-title text-white"><a href="add_food.jsp">Products Sold</a></h3>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-3">
                            <div class="card-body">
                                <h3 class="card-title text-white"><a href="">Products Sold</a></h3>
