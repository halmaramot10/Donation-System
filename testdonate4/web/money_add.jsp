<%-- 
    Document   : money_add
    Created on : Jan 4, 2020, 8:01:31 PM
    Author     : Hazel Anne
--%>
...
<head>
    ...
    <title>Add Money Donations</title>
    <!-- Favicon icon -->
                        ...
                        <div class="card">
                            <div class="card-body">                              
                                <div class="form-validation">
                                    ...
                                    <form class="form-valide" action="Add_Money" method="post">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="number" class="form-control" id="quantity" name="amount" required>
                                            </div>
                                        </div>                                                                                        
                                        ...
                                        <div class="form-group row">        
                                            ...
                                            <div class="col-lg-6">
                                                <input name="released" type="text" class="form-control" id="datepicker2">
                                            </div>
                                        </div>   
