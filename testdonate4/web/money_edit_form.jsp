<%-- 
    Document   : money_edit_form
    Created on : Jan 4, 2020, 8:02:25 PM
    Author     : Hazel Anne
--%>
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        ...
        <div class="content-body">
            ...
            <%
             int cid  = 0;
             String desc = null,type = null,amt = null,stat = null,donto = null,rec = null,don = null;
            %>
        <%
            try{
                ...
                rs = st.executeQuery("select * from money_donate where id="+cid+"");
                if(rs.next()){
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
                                    ...
                                    <form class="form-valide" action="Update_Money" method="post">
