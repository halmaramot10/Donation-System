<%-- 
    Document   : school_edit
    Created on : Jan 4, 2020, 7:48:44 PM
    Author     : Hazel Anne
--%>
...
<head>
    ...
    <title>Edit School Supply Donations</title>
    <!-- Favicon icon -->
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">List of School Supply Donations</h4>
                                    ...
                                    <table class="table table-striped table-bordered zero-configuration">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="school_edit_form.jsp?id=<%=rs.getInt("id")%>">Edit</a></td>
                                            </tr>
