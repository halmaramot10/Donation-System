<%-- 
    Document   : user_edit_form
    Created on : Dec 30, 2019, 11:46:31 AM
    Author     : Hazel Anne
--%>
                                ...
                                <div class="form-validation">
                                    ...
                                    <form class="form-valide" action="Update_User" method="post">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-firstname" name="fnamereg" value="<%=fname%>">
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-middlename" name="mnamereg" value="<%=mname%>">
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-lastname" name="lnamereg" value="<%=lname%>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-phone" name="phonereg" value="<%=phone%>">
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-position" name="position" value="<%=position%>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="email" class="form-control" id="val-email" name="email" value="<%=email2%>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="password" class="form-control" id="val-password" name="passreg" value="<%=password2%>">
                                            </div>
                                        </div>
